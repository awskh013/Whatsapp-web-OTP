...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .card{
    ...
    box-shadow:0 0 0 1px #ffffff08,0 32px 64px #00000080;
  ...
  .logo{
    width:56px;height:56px;background:var(--green-dim);border:1px solid #00e67633;
  ...
  .status-row{
    ...
    background:#ffffff05;border:1px solid var(--border);border-radius:12px;margin-bottom:12px;
  }
  ...
  .ep{
    ...
    background:#ffffff04;border-radius:8px;text-decoration:none;
...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  body{background:#0a0a0a;color:#f0f0f0;font-family:'Syne',sans-serif;min-height:100vh;display:flex;align-items:center;justify-content:center}
  body::before{content:'';position:fixed;inset:0;background-image:linear-gradient(#1e1e1e 1px,transparent 1px),linear-gradient(90deg,#1e1e1e 1px,transparent 1px);background-size:40px 40px;opacity:.4}
  .card{background:#111;border:1px solid #1e1e1e;border-radius:20px;padding:48px;text-align:center;max-width:380px;width:100%;animation:fadeUp .5s both}
  .icon{font-size:56px;margin-bottom:24px}
  h1{font-size:24px;font-weight:800;letter-spacing:-1px;color:#00e676;margin-bottom:8px}
  p{color:#555;font-family:'DM Mono',monospace;font-size:13px;margin-bottom:32px}
  a{display:inline-block;padding:12px 28px;background:#00e67618;color:#00e676;border:1px solid #00e67633;border-radius:10px;text-decoration:none;font-weight:700;font-size:14px;transition:all .2s}
  a:hover{background:#00e67628;transform:translateY(-2px)}
...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  body::before{content:'';position:fixed;inset:0;background-image:linear-gradient(#1e1e1e 1px,transparent 1px),linear-gradient(90deg,#1e1e1e 1px,transparent 1px);background-size:40px 40px;opacity:.4}
  .card{background:#111;border:1px solid #1e1e1e;border-radius:20px;padding:48px;text-align:center;max-width:380px;width:100%;animation:fadeUp .5s both}
  .spinner{width:48px;height:48px;border:2px solid #1e1e1e;border-top-color:#ffd600;border-radius:50%;animation:spin 1s linear infinite;margin:0 auto 24px}
  h1{font-size:22px;font-weight:800;letter-spacing:-1px;color:#ffd600;margin-bottom:8px}
  p{color:#555;font-family:'DM Mono',monospace;font-size:13px;margin-bottom:32px}
  a{display:inline-block;padding:12px 28px;background:#ffffff08;color:#f0f0f0;border:1px solid #1e1e1e;border-radius:10px;text-decoration:none;font-weight:700;font-size:14px;transition:all .2s}
...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  :root{--bg:#0a0a0a;--surface:#111;--border:#1e1e1e;--green:#00e676;--text:#f0f0f0;--muted:#555}
  ...
  body::before{content:'';position:fixed;inset:0;background-image:linear-gradient(var(--border) 1px,transparent 1px),linear-gradient(90deg,var(--border) 1px,transparent 1px);background-size:40px 40px;opacity:.4;pointer-events:none}
  .card{background:var(--surface);border:1px solid var(--border);border-radius:20px;padding:40px;max-width:420px;width:100%;text-align:center;animation:fadeUp .6s cubic-bezier(.16,1,.3,1) both;position:relative}
  .card::before{content:'';position:absolute;inset:0;border-radius:20px;background:linear-gradient(135deg,#ffffff06,transparent 60%);pointer-events:none}
  .badge{display:inline-flex;align-items:center;gap:6px;padding:6px 14px;background:#ffd60018;border:1px solid #ffd60033;border-radius:100px;font-size:12px;font-family:'DM Mono',monospace;color:#ffd600;margin-bottom:28px}
  .badge-dot{width:6px;height:6px;border-radius:50%;background:#ffd600;animation:pulse 1.5s infinite}
  h1{font-size:26px;font-weight:800;letter-spacing:-1px;margin-bottom:8px}
  .subtitle{color:var(--muted);font-size:13px;font-family:'DM Mono',monospace;margin-bottom:28px}
  .qr-wrap{
    background:#fff;border-radius:16px;padding:20px;display:inline-block;
    box-shadow:0 0 0 1px #ffffff15,0 0 40px #00e67620;
    margin-bottom:28px;position:relative;
  }
  .qr-wrap img{display:block;width:220px;height:220px;border-radius:4px}
  .steps{text-align:left;background:#ffffff05;border:1px solid var(--border);border-radius:12px;padding:20px;margin-bottom:24px}
  .step{display:flex;gap:12px;align-items:flex-start;margin-bottom:12px}
  .step:last-child{margin-bottom:0}
  .step-num{width:22px;height:22px;background:var(--green);color:#000;border-radius:6px;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:800;flex-shrink:0;margin-top:1px}
  .step-text{font-size:13px;color:var(--muted);line-height:1.5}
  .step-text strong{color:var(--text)}
  .refresh-bar{height:3px;background:var(--border);border-radius:2px;overflow:hidden;margin-bottom:20px}
  .refresh-bar-fill{height:100%;background:var(--green);border-radius:2px;animation:shrink 30s linear forwards}
  a{display:flex;align-items:center;justify-content:center;gap:8px;padding:13px;background:#ffffff08;border:1px solid var(--border);border-radius:12px;text-decoration:none;color:var(--text);font-weight:700;font-size:14px;transition:all .2s}
  a:hover{background:#ffffff12;transform:translateY(-2px)}
  @keyframes fadeUp{from{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}
